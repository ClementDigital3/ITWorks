    ...
    <main ref={revealRef}>
      ...
      <div className="quick-contact">
        <div className="quick-grid">
          <a href="https://wa.me/254142445499" className="quick-card wa reveal" target="_blank" rel="noreferrer">
            ...
            <div><div className="quick-label">Fastest Response</div><div className="quick-value">WhatsApp Us</div><div className="quick-sub">014 2445499 — usually within minutes</div></div>
          ...
          <a href="tel:+254142445499" className="quick-card reveal reveal-delay-1">
            ...
            <div><div className="quick-label">Call Directly</div><div className="quick-value">014 2445499</div><div className="quick-sub">Mon–Sat 8am–6pm</div></div>
            <div className="quick-arrow"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></div>
          </a>
        ...
        <div className="contact-inner">
          ...
          <div className="contact-info reveal reveal-delay-1">
            <div className="info-block">
              ...
              {[
                { icon:<path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.7A2 2 0 012.18 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.91 7.1a16 16 0 006 6l.56-.56a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92v2z"/>, label:'Phone & WhatsApp', val:'014 2445499', sub:'Call or WhatsApp — same numbers', href:'tel:+254142445499' },
